...
// require_once('libraries/utils.php');   ôter si clsass

/* INUTILE AVEC AUTOLOAD.PHP  : par contre à la "racine" ajouter "require_once('libraries/autoload.php');"v(index.php, save-comment.php...Etc)
...
{
    protected $modelName = "\Models\Comment";  // ou protected $modelName = \Models\Comment::class;
    ...
    public function insert()
    {
        ...
        */
        ...
        //  \Http::redirect("article.php?id=" . $article_id);   avec Application devient:
...
*/
        ...
        // $model = new Comment(); pas besoin dans controllers.php puid=squ'on l'a déjà dans $this->model
